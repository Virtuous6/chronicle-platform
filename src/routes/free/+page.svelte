<svelte:head>
  <title>The 7th Signal Free</title>
  <meta name="description" content="Get started with The 7th Signal for free. Access essential features and explore what's possible." />
</svelte:head>
...
<div class="min-h-screen bg-chronicle-bg">
  ...
  <main class="mx-auto max-w-3xl px-6 py-16">
    ...
    <div class="font-serif text-lg text-chronicle-text leading-relaxed space-y-6">
      <p>
        Experience the power of The 7th Signal at no cost. Our free tier gives you access to essential features,
        letting you explore what's possible before committing to a paid plan.
      </p>
      <p class="text-chronicle-text-muted">
        More details coming soon. Stay tuned for announcements about features, limits, and how to get started.
      </p>
    </div>
  </main>
