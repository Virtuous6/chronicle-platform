...
<svelte:head>
  <title>Models - The 7th Signal</title>
  <meta name="description" content="Explore the AI models powering The 7th Signal platform." />
</svelte:head>

<div class="min-h-screen bg-chronicle-bg">
  <!-- Header -->
  <header class="border-b border-chronicle-border">
    <nav class="mx-auto max-w-[1400px] px-6 py-4 flex items-center justify-between">
  ...
  <main class="mx-auto max-w-3xl px-6 py-16">
    ...
    <div class="font-serif text-lg text-chronicle-text leading-relaxed space-y-6">
      <p>
        The 7th Signal leverages state-of-the-art AI models to deliver intelligent content analysis, 
        generation, and curation capabilities.
      </p>
      <p>
        Our platform integrates with leading foundation models, enabling powerful reasoning, 
        natural language understanding, and creative generation across all content types.
      </p>
      <p class="text-chronicle-text-muted">
        Detailed model specifications and capabilities coming soon.
      </p>
    </div>
  </main>
