<svelte:head>
  <title>Press Kit - The 7th Signal</title>
  <meta name="description" content="Brand assets, logos, and press contacts for The 7th Signal" />
</svelte:head>

<div class="min-h-screen bg-chronicle-bg">
  <!-- Header -->
  <header class="border-b border-chronicle-border">
    <nav class="mx-auto max-w-[1400px] px-6 py-4 flex items-center">
  ...
  <main class="mx-auto max-w-3xl px-6 py-16">
    <!-- Title -->
    <h1 class="font-display text-5xl md:text-6xl lg:text-7xl text-chronicle-text italic mb-12 leading-tight">
      Press Kit
    </h1>

    <!-- Brand Assets Section -->
    <section class="mb-16">
      <h2 class="font-display text-2xl text-chronicle-text mb-6">Brand Assets</h2>
      <div class="border border-chronicle-border rounded-lg p-8 bg-chronicle-bg-light">
        <p class="font-serif text-chronicle-text-muted">
          Logos, wordmarks, and brand guidelines coming soon.
        </p>
      </div>
    </section>
    ...
    <!-- Logos Section -->
    <section class="mb-16">
      <h2 class="font-display text-2xl text-chronicle-text mb-6">Logos</h2>
      <div class="border border-chronicle-border rounded-lg p-8 bg-chronicle-bg-light">
        <p class="font-serif text-chronicle-text-muted">
          Download our logos in various formats (SVG, PNG, EPS). Coming soon.
        </p>
      </div>
    </section>
    ...
    <section class="mb-16">
      <h2 class="font-display text-2xl text-chronicle-text mb-6">Press Contacts</h2>
      <div class="border border-chronicle-border rounded-lg p-8 bg-chronicle-bg-light">
        <p class="font-serif text-chronicle-text-muted mb-4">
          For press inquiries, please contact:
        </p>
        <p class="font-serif text-chronicle-text">
          press@the7thsignal.com
        </p>
      </div>
    </section>
  </main>
  ...
  <footer class="border-t border-chronicle-border mt-20">
    <div class="mx-auto max-w-[1400px] px-6 py-16">
      <div class="flex flex-col md:flex-row md:justify-between gap-12">
        ...
        <div class="flex flex-wrap gap-12 md:gap-16 text-sm">
          <div>
